...
type
  ...
  TPvCameraInfo = record
    ...
    SerialString    : array[1..32] of AnsiChar; // Camera's serial number
    ...
    DisplayName     : array[1..16] of AnsiChar; // People-friendly camera name
...
// Attribute information type
  TPvAttributeInfo = record
    ...
    Category  : PAnsiChar;                 // Advanced: see documentation
    Impact    : PAnsiChar;                 // Advanced: see documentation
    _Reserved : array[1..4] of DWord;  // Always zero
  end;
...
function PvAttrInfo(Camera:TPvHandle;const Name:PAnsiChar;
                    var Info:TPvAttributeInfo):TPvErr; stdcall;

function PvAttrExists(Camera:TPvHandle;const Name:PAnsiChar):TPvErr; stdcall;

function PvAttrIsAvailable(Camera:TPvHandle;const Name:PAnsiChar):TPvErr; stdcall;

function PvAttrIsValid(Camera:TPvHandle;const Name:PAnsiChar):TPvErr; stdcall;

function PvAttrRangeEnum(Camera:TPvHandle;const Name:PAnsiChar;pBuffer:PAnsiChar;
                         BufferSize:DWord;var Size:DWord):TPvErr; stdcall;

function PvAttrRangeUint32(Camera:TPvHandle;const Name:PAnsiChar;
                           var Min,Max:DWord):TPvErr; stdcall;

function PvAttrRangeFloat32(Camera:TPvHandle;const Name:PAnsiChar;var Min,Max:Single):TPvErr; stdcall;

function PvCommandRun(Camera:TPvHandle;const Name:PAnsiChar):TPvErr; stdcall;

function PvAttrStringGet(Camera:TPvHandle;const Name:PAnsiChar;Buffer:PAnsiChar;
                         BufferSize:DWord;var Size:DWord):TPvErr; stdcall;

function PvAttrStringSet(Camera:TPvHandle;const Name:PAnsiChar;
                         const Value:PAnsiChar):TPvErr; stdcall;

function PvAttrEnumGet(Camera:TPvHandle;const Name:PAnsiChar;Buffer:PAnsiChar;
                       BufferSize:DWord;var Size:DWord):TPvErr; stdcall;

function PvAttrEnumSet(Camera:TPvHandle;const Name,Value:PAnsiChar):TPvErr; stdcall;

function PvAttrUint32Get(Camera:TPvHandle;const Name:PAnsiChar;
                         var Value:DWord):TPvErr; stdcall;

function PvAttrUint32Set(Camera:TPvHandle;const Name:PAnsiChar;
                         Value:DWord):TPvErr; stdcall;

function PvAttrFloat32Get(Camera:TPvHandle;const Name:PAnsiChar;
                          var Value:Single):TPvErr; stdcall;

function PvAttrFloat32Set(Camera:TPvHandle;const Name:PAnsiChar;
