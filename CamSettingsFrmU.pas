...
uses
  ...
  Dialogs, NBFill, StdCtrls, ExtCtrls, AprSpin, AprChkBx, Vcl.ComCtrls;
...
type
  TCamSettingsFrm = class(TForm)
    ...
    Panel3: TPanel;
    Label5: TLabel;
    WhiteBalanceRedEdit: TNBFillEdit;
    AutoWhiteBalanceCB: TAprCheckBox;
    Panel4: TPanel;
    Label6: TLabel;
    Label3: TLabel;
    Label4: TLabel;
    PacketSizeEdit: TAprSpinEdit;
    StreamBytesPerSecondEdit: TAprSpinEdit;
    MulticastCB: TAprCheckBox;
    WhiteBalanceBlueEdit: TNBFillEdit;
    WhiteBalanceRateEdit: TAprSpinEdit;
...
begin
  ...
  StreamBytesPerSecondEdit.Value:=Camera.StreamBytesPerSecond/1000000;
...
procedure TCamSettingsFrm.SmoothCBClick(Sender: TObject);
begin
